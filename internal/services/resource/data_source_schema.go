...
var _ datasource.DataSourceWithConfigValidators = (*ResourceDataSource)(nil)
...
func (d *ResourceDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
