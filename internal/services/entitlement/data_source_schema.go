...
var _ datasource.DataSourceWithConfigValidators = (*EntitlementDataSource)(nil)
...
func (d *EntitlementDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
