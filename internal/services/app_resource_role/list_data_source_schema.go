...
var _ datasource.DataSourceWithConfigValidators = (*AppResourceRolesDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[AppResourceRolesItemsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"provisioning_method": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[AppResourceRolesProvisioningMethodDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								...
								"custom_workflow": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[AppResourceRolesProvisioningMethodCustomWorkflowDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
								...
								"linked_roles": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[AppResourceRolesProvisioningMethodLinkedRolesDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
								...
								"manual": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[AppResourceRolesProvisioningMethodManualDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"assignees": schema.ListNestedAttribute{
											...
											Computed:    true,
											CustomType:  customfield.NewNestedObjectListType[AppResourceRolesProvisioningMethodManualAssigneesDataSourceModel](ctx),
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
...
func (d *AppResourceRolesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *AppResourceRolesDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
