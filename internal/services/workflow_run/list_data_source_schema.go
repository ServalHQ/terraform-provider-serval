...
var _ datasource.DataSourceWithConfigValidators = (*WorkflowRunsDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[WorkflowRunsItemsDataSourceModel](ctx),
...
func (d *WorkflowRunsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *WorkflowRunsDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
