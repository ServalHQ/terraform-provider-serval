...
var _ datasource.DataSourceWithConfigure = (*AppResourcesDataSource)(nil)

func NewAppResourcesDataSource() datasource.DataSource {
	return &AppResourcesDataSource{}
}

func (d *AppResourcesDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_app_resources"
}

func (d *AppResourcesDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AppResourcesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	result, diags := customfield.NewObjectListFromAttributes[AppResourcesItemsDataSourceModel](ctx, acc)
	resp.Diagnostics.Append(diags...)
	data.Items = result
