...
- `email` (String)
- `first_name` (String)
- `groups` (Attributes List) (see [below for nested schema](#nestedatt--users--groups))
- `id` (String)
- `last_name` (String)
- `name` (String)
- `role` (String)
- `teams` (Attributes List) (see [below for nested schema](#nestedatt--users--teams))
...
- `role` (String) Available values: "TEAM_ROLE_UNSPECIFIED", "TEAM_ROLE_MANAGER", "TEAM_ROLE_AGENT".
- `team` (Attributes) (see [below for nested schema](#nestedatt--users--teams--team))

<a id="nestedatt--users--teams--team"></a>
### Nested Schema for `users.teams.team`
