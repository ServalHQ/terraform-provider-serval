...
- `time_allocations` (Attributes List) Every access request contains one or more time allocations. A time
 ...
 Ordered by creation time ascending. (see [below for nested schema](#nestedatt--time_allocations))

<a id="nestedatt--time_allocations"></a>
### Nested Schema for `time_allocations`
